...
def run_tests():
    print("\n" + "="*80)
    print("🌊 深海灯笼 (deep-sea-lantern) - 第5轮测试")
    print("="*80 + "\n")
    ...
    with sync_playwright() as p:
        ...
        try:
            time.sleep(1.5)
            page.screenshot(path=f"{img_dir}/r5_01_before_mouse.png")
        ...
        try:
            ...
            if box:
                ...
                time.sleep(2)
                page.screenshot(path=f"{img_dir}/r5_02_diver_light_center.png")
        ...
        try:
            ...
            if box:
                ...
                for i, (ox, oy, name) in enumerate(positions):
                    ...
                    time.sleep(1)
                    page.screenshot(path=f"{img_dir}/r5_03_light_{name}.png")
        ...
        try:
            ...
            if box:
                ...
                # 移动到底部偏左和偏右区域
                for i, (ox, name) in enumerate([(-150, "left_bottom"), (150, "right_bottom")]):
                    page.mouse.move(center_x + ox, center_y + 150)
                    time.sleep(1.5)
                    page.screenshot(path=f"{img_dir}/r5_04_reef_{name}.png")
                
                log_test("5. 底部礁石生物", True, "已截图")
                test_results.append(("底部礁石生物", True, "已截图"))
            else:
                log_test("5. 底部礁石生物", False, "无法测试")
                test_results.append(("底部礁石生物", False, "无法测试"))
        except Exception as e:
            log_test("5. 底部礁石生物", False, str(e))
            test_results.append(("底部礁石生物", False, str(e)))
