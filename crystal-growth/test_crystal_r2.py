...
def run():
    with sync_playwright() as p:
        ...
        print("[2] 初始状态截图(第2轮)...", flush=True)
        try:
            page.screenshot(path=f"{IMG_DIR}/r2_initial.png", timeout=15000)
            results["screenshots"].append("r2_initial.png")
        ...
        time.sleep(8)
        try:
            page.screenshot(path=f"{IMG_DIR}/r2_grown.png", timeout=15000)
            results["screenshots"].append("r2_grown.png")
            print("    截图成功", flush=True)
        except Exception as e:
            print(f"    截图失败: {e}", flush=True)
        ...
        time.sleep(8)
        try:
            page.screenshot(path=f"{IMG_DIR}/r2_fully_grown.png", timeout=15000)
            results["screenshots"].append("r2_fully_grown.png")
            print("    截图成功", flush=True)
        except Exception as e:
            print(f"    截图失败: {e}", flush=True)
        ...
        try:
            ...
            time.sleep(2)
            page.screenshot(path=f"{IMG_DIR}/r2_after_reset.png", timeout=15000)
            results["screenshots"].append("r2_after_reset.png")
        ...
        time.sleep(8)
        try:
            page.screenshot(path=f"{IMG_DIR}/r2_regrown.png", timeout=15000)
            results["screenshots"].append("r2_regrown.png")
            print("    截图成功", flush=True)
        except Exception as e:
            print(f"    截图失败: {e}", flush=True)
        ...
        try:
            ...
            time.sleep(2)
            page.screenshot(path=f"{IMG_DIR}/r2_after_R.png", timeout=15000)
            results["screenshots"].append("r2_after_R.png")
    ...
    with open(f"{IMG_DIR}/test_results_r2.json", "w", encoding="utf-8") as f:
