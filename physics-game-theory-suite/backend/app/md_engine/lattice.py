...
LatticeType = Literal["fcc", "sc", "bcc"]
...
def create_lattice(
    ...
    if lattice_type == "fcc":
        return create_fcc_lattice(n_unit_cells, density, mass)
    elif lattice_type == "sc":
        return create_sc_lattice(n_unit_cells, density, mass)
    elif lattice_type == "bcc":
        return create_bcc_lattice(n_unit_cells, density, mass)
    else:
