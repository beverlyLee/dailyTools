...
async def test_matchmaking_app():
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            await page.screenshot(path=os.path.join(IMG_DIR, "r2_1_homepage.png"), full_page=True)
            screenshots.append("r2_1_homepage.png - 首页加载")
            ...
            if await sidebar.count() == 0:
                errors.append("未找到侧边栏")
            else:
                screenshots.append("侧边栏已找到")
            ...
            if await selectbox_click_area.count() > 0:
                ...
                try:
                    ...
                    if await beijing_option.count() > 0:
                        ...
                        await page.screenshot(path=os.path.join(IMG_DIR, "r2_2_beijing_wordcloud.png"), full_page=True)
                        screenshots.append("r2_2_beijing_wordcloud.png - 北京词云图")
                ...
                try:
                    ...
                    if await shanghai_option.count() > 0:
                        ...
                        await asyncio.sleep(8)
                        await page.screenshot(path=os.path.join(IMG_DIR, "r2_3_shanghai_wordcloud.png"), full_page=True)
                        screenshots.append("r2_3_shanghai_wordcloud.png - 上海词云图")
                ...
                try:
                    ...
                    if await shenzhen_option.count() > 0:
                        ...
                        await page.screenshot(path=os.path.join(IMG_DIR, "r2_3a_shenzhen_wordcloud.png"), full_page=True)
                        screenshots.append("r2_3a_shenzhen_wordcloud.png - 深圳词云图")
                    else:
                ...
                await page.screenshot(path=os.path.join(IMG_DIR, "r2_1b_debug_no_selectbox.png"), full_page=True)
                screenshots.append("r2_1b_debug_no_selectbox.png - 调试截图(无选择框)")
            
            stats_tab = page.get_by_text("统计数据")
            if await stats_tab.count() > 0:
                await stats_tab.first.click()
                await asyncio.sleep(6)
                await page.screenshot(path=os.path.join(IMG_DIR, "r2_4_statistics.png"), full_page=True)
                screenshots.append("r2_4_statistics.png - 统计数据标签页")
            else:
            ...
            if await raw_data_tab.count() > 0:
                ...
                await page.screenshot(path=os.path.join(IMG_DIR, "r2_5_raw_data.png"), full_page=True)
                screenshots.append("r2_5_raw_data.png - 原始数据标签页")
            else:
            ...
            if await wordcloud_tab.count() > 0:
                ...
                await page.screenshot(path=os.path.join(IMG_DIR, "r2_6_wordcloud_tab.png"), full_page=True)
                screenshots.append("r2_6_wordcloud_tab.png - 词云图标签页")
            else:
            ...
            try:
                await page.screenshot(path=os.path.join(IMG_DIR, "r2_error_load.png"), full_page=True)
                screenshots.append("r2_error_load.png - 加载错误截图")
            except:
                pass
