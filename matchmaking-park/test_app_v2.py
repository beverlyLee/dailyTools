    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            if len(select_elements) > 0:
                ...
                try:
                    await city_select.select_option("深圳")
                    await asyncio.sleep(5)
                    await page.screenshot(path=os.path.join(IMG_DIR, "3a_shenzhen_wordcloud.png"), full_page=True)
                    screenshots.append("3a_shenzhen_wordcloud.png - 深圳词云图")
                except Exception as e:
