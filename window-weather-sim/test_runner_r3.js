...
async function runTests() {
  ...
  await screenshot(page, 'r3_test_01_initial_state');
  ...
  await screenshot(page, 'r3_test_02_sliding_storm');
  ...
  await screenshot(page, 'r3_test_03_casement_window');
  ...
  await screenshot(page, 'r3_test_04_casement_storm');
  ...
  await screenshot(page, 'r3_test_05_after_reset');
