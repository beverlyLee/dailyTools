import { View, Bounds, Point } from '../core';
import { PDFModel } from './PDFModel';
import { Annotation, HighlightAnnotation, UnderlineAnnotation, TextboxAnnotation, FreehandAnnotation } from './types';
import * as pdfjsLib from 'pdfjs-dist';

pdfjsLib.GlobalWorkerOptions.workerSrc = `https://cdnjs.cloudflare.com/ajax/libs/pdf.js/3.11.174/pdf.worker.min.js`;

export class PDFView extends View<PDFModel> {
